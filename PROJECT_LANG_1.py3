...
"""
print ("LANG1.py")
print ("I made this language file, so that a programming language is \
       associated with this project. I chose to make 2, \
       but more prominently with Python. I chose the 2 languages \
       that I am best at.")
